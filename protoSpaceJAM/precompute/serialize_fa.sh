# mRatBN7.2
rm -rf genome_files/fa_pickle/mRatBN7.2
mkdir genome_files/fa_pickle/mRatBN7.2
python ./scripts/serialize_fa.py --fastagz genome_files/Rattus_norvegicus.mRatBN7.2.dna_sm.toplevel.fa.gz --outdir genome_files/fa_pickle/mRatBN7.2
