...
def cross_validate(
    ...
    if not CV:
        ...
        ), "Must use gene-CV when CV is False (I need to use all of the genes and stratified complicates that)"

    # set-up for cross-validation
    ## for outer loop, the one Doench et al use genes for
    if learn_options["cv"] == "stratified":
        assert (
            "extra_pairs" not in learn_options or learn_options["extra pairs"]
    ...
    if num_proc > 1:
        ...
        for i, fold in enumerate(cv):
            ...
            if learn_options["method"] == "GPy":
                ...
                job = pool.apply_async(
                    azimuth.models.baselines.random_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    azimuth.models.baselines.mean_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    azimuth.models.baselines.SVC_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    azimuth.models.DNN.DNN_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    azimuth.models.baselines.doench_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
        ...
        for i, fold in enumerate(cv):
            ...
            if learn_options["method"] == "GPy":
                y_pred, m[i] = gp_on_fold(
                    azimuth.models.GP.feature_sets,
                    train,
                    test,
                    y,
                    y_all,
