...
def get_parser():
    ...
    parser.add_argument("--wt", type=str, help="WT 23mer sgRNA sequence")
    parser.add_argument("--off", type=str, help="Off-target 23mer sgRNA sequence")
    return parser
...
def get_mm_pam_scores():
    try:
        mm_scores = pickle.load(open(
            "mismatch_score.pkl", "rb"))
        pam_scores = pickle.load(open(
            "pam_scores.pkl", "rb"))
