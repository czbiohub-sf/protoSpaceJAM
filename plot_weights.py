...
def parse_args():
    ...
    parser.add_argument('--num_to_process', default="all", type=str, help='this parameter decides which file to load, the files have name start/stop_gRNAs_of_{num_to_process}_genes.pickle', metavar='')
