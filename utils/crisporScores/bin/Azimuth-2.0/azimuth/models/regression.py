        ...
        for i, alpha in enumerate(learn_options["alpha"]):
            for j, l1r in enumerate(l1_ratio):
                ...
                if learn_options["training_metric"] == "AUC":
                    ...
                    spearman = azimuth.util.spearmanr_nonan(
                        y_all[learn_options["ground_truth_label"]][train][test_inner],
                        tmp_pred.flatten(),
                    )[0]
                    ...
                    tmp_perf = ranking_metrics.ndcg_at_k_ties(
                    ...
                    tmp_pred_r, tmp_truth_r = ranking_metrics.rank_data(
                        tmp_pred, tmp_truth
                    )
...
def set_up_inner_folds(learn_options, y):
    ...
    if (
        learn_options["ignore_gene_level_for_inner_loop"]
