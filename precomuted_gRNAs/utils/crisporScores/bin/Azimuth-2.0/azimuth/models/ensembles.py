...
# from sklearn.model_selection import GridSearchCV # new sklearn
import sklearn
...
# from sklearn.model_selection import GridSearchCV # new sklearn
# from sklearn.model_selection import cross_val_score # new sklearn
    ...
    if learn_options["adaboost_version"] == "python":
        if not learn_options["adaboost_CV"]:
            ...
            if learn_options["algorithm_hyperparam_search"] == "bo":
                ...
                cv = sklearn.cross_validation.KFold(
                    X[train].shape[0], n_folds=n_folds, shuffle=True
                )
