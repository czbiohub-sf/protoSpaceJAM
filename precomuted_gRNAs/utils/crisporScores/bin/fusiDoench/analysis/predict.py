    ...
    if num_proc > 1:
        ...
        for i, fold in enumerate(cv):
            ...
            if learn_options["method"] == "GPy":
                ...
                job = pool.apply_async(
                    precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.linreg_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.logreg_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.ARDRegression_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
                ...
                job = pool.apply_async(
                    precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.DNN.DNN_on_fold,
                    args=(
                        feature_sets,
                        train,
                        test,
        ...
        for i, fold in enumerate(cv):
            ...
            if learn_options["method"] == "GPy":
                ...
                y_pred, m[i] = precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.linreg_on_fold(
                    feature_sets,
                    train,
                    test,
                    y,
                ...
                y_pred, m[i] = precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.logreg_on_fold(
                    feature_sets,
                    train,
                    test,
                    y,
                ...
                y_pred, m[i] = precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.regression.ARDRegression_on_fold(
                    feature_sets,
                    train,
                    test,
                    y,
                ...
                y_pred, m[i] = precomuted_gRNAs.utils.crisporScores.bin.fusiDoench.analysis.models.DNN.DNN_on_fold(
                    feature_sets,
                    train,
                    test,
                    y,
