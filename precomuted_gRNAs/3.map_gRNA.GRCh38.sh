...
gzdir="gRNA_GRCh38/gRNA.tab.gz.split" # need to change this for other genomes
genome_fa="Homo_sapiens.GRCh38.dna_sm.primary_assembly.fa" # need to change this for other genomes
