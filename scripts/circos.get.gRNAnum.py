...
def bin_gRNA_num(bin_size, df, outdir):
    ...
    log.info(f"bin_size={str(int(bin_size / 1000))}kb, finished in {elapsed_min:.2f} min, processed {chr_count} chromosomes, {gRNA_count} gRNAs")
    print(f"bin_size={str(int(bin_size / 1000))}kb, finished in {elapsed_min:.2f} min, processed {chr_count} chromosomes, {gRNA_count} gRNAs")
